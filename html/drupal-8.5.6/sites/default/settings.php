 ...
 * @endcode
 */
$settings['hash_salt'] = '0Sihzpu1df2_oDJaYorgi9hfkzno5jZreCWRud_hJDBLFfc8s-IdWdiHBnh1Vrqo1reccg3ZeA';
...
//trusted host pattern for localhost
  /*/$settings['trusted_host_patterns'] = array(
   '^localhost$','^127.0.0.1$'
  );/*/
...
$config_directories['sync'] = 'sites/default/files/config_JGTicsgzuos6Qfg6F8Y2Sf1f4gcy6idzzjvt4q7ft6Z4trC5M6y-JnnovfdfaADWPzmwijheyA/sync';
